        ...
        return (
            _createClass(a, [
                ...
                },
                {
                    key: "exit",
                    value: function (a) {
                        this.stopSpeaking(), this.runSingleEvent([{ type: "anim", anim: "surf_away", ticks: 30 }]), setTimeout(a, 2e3);
                    },
                },
                {
                    key: "deconstruct",
                ...
                },
                {
                    ...
                    value: function (a) {
                        this.runSingleEvent([
                            ...
                            {
                                type: "text",
                                text: "I am trained in gorilla warfare and I'm the top hacker in the entire US armed forces. You are nothing to me but just another target.",
                            },
                            {
                                type: "text",
    ...
    (BonziData.event_list_bees = [
        ...
        { type: "text", text: "You are in a coma. This is our only way to communicate. Please wake up." },
                  ...
                  $(document).ready(function () {
                    ...
                    for (var a = ["amethyst", "azure", "black", "blue", "brown", "burgundy", "chocolate", "dark_blue", "diamond", "emerald", "gold", "green", "indigo", "intel_blue", "magenta", "milk", "navy_blue", "orange", "peridot", "pink", "purple", "rainbow", "red", "red_orange", "ruby", "sapphire", "scarlet", "siam", "strawberry_milk", "tanzanite", "turquoise", "water_blue", "yellow", "pope", "god"], b = 0; b < a.length; b++) {
                        var c = a[b],
