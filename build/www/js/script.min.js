    ...
    (BonziData.event_list_bees = [
        ...
        { type: "text", text: "You are in a coma. This is our only way to communicate. Please wake up." },
                  ...
                  $(document).ready(function () {
                    ...
                    for (var a = ["amethyst", "azure", "black", "blue", "brown", "burgundy", "chocolate", "dark_blue", "diamond", "emerald", "gold", "green", "indigo", "intel_blue", "magenta", "milk", "navy_blue", "orange", "peridot", "pink", "purple", "rainbow", "red", "red_orange", "ruby", "sapphire", "scarlet", "siam", "strawberry_milk", "tanzanite", "turquoise", "water_blue", "yellow", "pope", "god", "old_god", "omega"], b = 0; b < a.length; b++) {
                        var c = a[b],
