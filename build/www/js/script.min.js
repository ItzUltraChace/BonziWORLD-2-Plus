            ...
            _createClass(a, [
                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        if (this.run) {
							if (window.gravity || this.userPublic.hue != 0 || this.userPublic.saturation != 100) {
							...
							this.sprite.scaleX = this.userPublic.scalex;
							this.sprite.scaleY = this.userPublic.scaley;
							this.sprite.skewX = this.userPublic.skewx;
							this.sprite.skewY = this.userPublic.skewy;
                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        if (!this.mute) {
							...
							nametag = nametag.replaceAll(/fune/gi,"Seamus")
							nametag = nametag.replaceAll(/{COLOR}/gi,"(COLOR)")
                            this.$nametag.html(nametag+this.userPublic.typing);
